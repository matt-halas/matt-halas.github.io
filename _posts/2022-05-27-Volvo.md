...
My focus for this project was on the engine of the UAV. For this analysis, we used a simple cylindrical engine with a flame holder blocking 40% of the combustor area. The combustor geometry is shown in figure 1. This 
